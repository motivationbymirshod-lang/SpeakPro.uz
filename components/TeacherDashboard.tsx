...
const TeacherDashboard: React.FC<TeacherDashboardProps> = ({ user: initialUser, onLogout }) => {
    ...
    useEffect(() => {
        const refreshData = async () => {
            try {
                ...
                const uRes = await fetch(`https://speakpro-uz.onrender.com/api/user/${initialUser.email}`);
                if (uRes.ok) {
                ...
                // 2. Refresh Students
                const sRes = await fetch(`https://speakpro-uz.onrender.com/api/teacher/students?teacherId=${initialUser._id || initialUser.id}`);
                if (sRes.ok) {
    ...
    const handleAddStudent = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            const res = await fetch('https://speakpro-uz.onrender.com/api/teacher/create-student', {
                method: 'POST',
            ...
            if (res.ok) {
                ...
                // Refresh List
                const sRes = await fetch(`https://speakpro-uz.onrender.com/api/teacher/students?teacherId=${user._id || user.id}`);
                const sData = await sRes.json();
                setStudents(sData);
            } else {
                alert(data.message);
    ...
    const handleDistributeCredit = async (studentId: string) => {
        ...
        try {
            const res = await fetch('https://speakpro-uz.onrender.com/api/teacher/distribute-credit', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleUpdatePassword = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('https://speakpro-uz.onrender.com/api/admin/change-password', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
